...
`./check-conformance.sh` (a.k.a. `just check-conformance`) runs against the actual files. **Read each check as the narrow thing it proves — not as proof of seat indistinguishability** (see §1 inv 1, §16#1):
